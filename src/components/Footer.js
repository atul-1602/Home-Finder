...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-neutral-800 via-neutral-700 to-neutral-800 text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h4 className="text-3xl font-bold gradient-text">HomeFinder</h4>
            </div>
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a 
                  key={social.name}
                  href="#" 
                  className="w-12 h-12 bg-gradient-to-br from-neutral-600 to-neutral-700 hover:from-primary-500 hover:to-primary-600 text-neutral-300 hover:text-white rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link 
                    href={link.href} 
                    className="flex items-center space-x-3 text-neutral-300 hover:text-white transition-all duration-300 hover:translate-x-2 group"
                    style={{ animationDelay: `${index * 50}ms` }}
                  >
                    <div className="w-6 h-6 bg-neutral-600 group-hover:bg-primary-500 rounded-lg flex items-center justify-center transition-colors duration-300">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-center space-x-3 group">
                  <div className={`w-10 h-10 bg-gradient-to-br ${contact.color} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={contact.icon} />
                    </svg>
                  </div>
                  <span className="text-neutral-300 group-hover:text-white transition-colors duration-300 text-sm">
                    {contact.text}
                  </span>
                </div>
              ))}
        ...
        <div className="border-t border-neutral-600 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-neutral-400 text-center md:text-left">
              © 2024 HomeFinder. All rights reserved.
            </p>
